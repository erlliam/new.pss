...
argglobal
if bufexists('/usr/share/vim/vim81/doc/gui.txt') | buffer /usr/share/vim/vim81/doc/gui.txt | else | edit /usr/share/vim/vim81/doc/gui.txt | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 458 - ((20 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
458
